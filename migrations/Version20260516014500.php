...
final class Version20260516014500 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE source_lookup_cache ADD COLUMN IF NOT EXISTS provider_trace LONGTEXT DEFAULT NULL');
        $this->addSql('ALTER TABLE source_lookup_cache ADD COLUMN IF NOT EXISTS rejection_reasons LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE source_lookup_cache DROP COLUMN IF EXISTS rejection_reasons');
        $this->addSql('ALTER TABLE source_lookup_cache DROP COLUMN IF EXISTS provider_trace');
    }
}
